...
News
-----
* 2018-03-05: Today **itom 3.1.0** has been released. The Windows setups and the sources (tag v3.1.0) are ready for download. It comes with a lot of bugfixes, improvements. The plot engine has been extended and improved. Now it is possible to plot x over y vector data. **plot1**, **plot2**, **plot25** has been to added to specify **1d**, **2d** or **2.5d** plot. Palettes editor added to edit and create custom color palettes. **itom** snapshot dialog has been added by a timestamp feature. Plugin to connect PMD camera has been added. 
* 2017-04-12: Today **itom 3.0.0** has been released. The Windows setups and the sources (tag v3.0.0) are ready for download. It comes with a lot of bugfixes, improvements and new plugins, like **GenICam**, **ThorlabsPowerMeter**, **NITWidySWIR**. For more information see the changelog at http://itom.bitbucket.io/latest/docs/00_releaseNotes/whats-new.html.
