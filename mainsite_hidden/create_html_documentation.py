...
def createDocumentation(buildernames):
    ...
    srcdir = pathConv(os.path.join(itom.getCurrentPath(), "source"))
    confdir = pathConv(os.path.join(itom.getCurrentPath(), "source"))
    
    for buildername in buildernames:
        outdir = pathConv(os.path.join(itom.getCurrentPath(),"build/" + buildername))
