...
def createDocumentation(buildernames):
    ...
    srcdir = pathConv(os.path.join(basedir, "source_plugins"))
    confdir = pathConv(os.path.join(basedir, "source_plugins"))

    for buildername in buildernames:
        outdir = pathConv(
            os.path.join(basedir, "build/" + buildername + "/plugindoc")
        )
        doctreedir = pathConv(os.path.join(basedir, "build/doctrees"))
        postcopydir = pathConv(os.path.join(basedir, "../plugindoc"))
...
license browse to http://www.alliedvisiontec.com. This plugin was mainly tested with the cameras AVT Malin, Guppy and Pike. Not all parameters are supported by this plugin.",
    ...
    d = {
        "license": "licensed under LGPL. For further license information of the **xiQ** interface from Ximea see its specific documentation.",
...
For compiling this plugin, please set the CMake variable **XIMEA_APIDIR** to the base directory of the Ximea API. This directory must contain the file *m3Api.h*.",
    ...
    d = {
        "license": "licensed under LGPL. For the license information of **FlyCapture2** see the specific documentation of Point Grey Research.",
...
For compiling this plugin, install FlyCapture2 in 32bit or 64bit depending on **itom** and set the CMake variable **PGRFLYCAP_API_DIR** to the base directory of FlyCapture2.",
    ...
    d = {
        "license": "licensed under LGPL / ISO5436-2 XML under LPGL",
