...
The **itom** setup already comes with many exemplary plugins. Other plugins are available as source files in the corresponding plugin repository (`Plugins <https://bitbucket.org/itom/plugins>`_). 
