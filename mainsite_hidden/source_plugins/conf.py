...
sys.path.append(
    os.path.join(itom.getAppPath(), "SDK" + os.sep + "docs" + os.sep + "sphinxext")
)
...
copyright = (
    f"2011-{today}, Institut für Technische Optik (ITO), University Stuttgart. "
    "Bug report: https://github.com/itom-project/plugins/issues"
)
